(define (domain grid)
  ...
  (:action pickup
    ...
    :precondition (and
      (Feature_4_v0_s0 ?Arg1 ?Arg0) (Feature_2_v0_s0 ?Arg1) (Feature_3_v0_s1 ?Arg0) (Feature_0_v0_s0)
      (Static_pickup ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_3_v0_s0 ?Arg0) (Feature_0_v0_s1) (Feature_4_v0_s1 ?Arg1 ?Arg0)
      (not (Feature_4_v0_s0 ?Arg1 ?Arg0)) (not (Feature_3_v0_s1 ?Arg0)) (not (Feature_0_v0_s0))
    )
  )
  ...
  (:action putdown
    :parameters (?Arg0 - Type1 ?Arg1 - Type0)
    :precondition (and
      (Feature_3_v0_s0 ?Arg0) (Feature_4_v0_s1 ?Arg1 ?Arg0) (Feature_0_v0_s1) (Feature_1_v0_s0 ?Arg1)
      (Static_putdown ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_4_v0_s0 ?Arg1 ?Arg0) (Feature_3_v0_s1 ?Arg0) (Feature_0_v0_s0)
      (not (Feature_3_v0_s0 ?Arg0)) (not (Feature_0_v0_s1)) (not (Feature_4_v0_s1 ?Arg1 ?Arg0))
    )
  )
)
