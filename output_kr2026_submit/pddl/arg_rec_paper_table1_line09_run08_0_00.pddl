(define (domain logistics)
  ...
  (:action load
    ...
    :precondition (and
      (Feature_0_v0_s1 ?Arg0 ?Arg1) (Feature_3_v0_s0 ?Arg1 ?Arg2) (Feature_1_v0_s0 ?Arg0 ?Arg2) (Feature_2_v0_s0 ?Arg1 ?Arg2)
  ...
  (:action drive
    ...
    :precondition (and
      (Feature_2_v0_s1 ?Arg0 ?Arg1) (Feature_2_v0_s0 ?Arg0 ?Arg3) (Static_drive ?Arg0 ?Arg1 ?Arg2 ?Arg3)
    )
    :effect (and
      (Feature_2_v0_s1 ?Arg0 ?Arg3) (Feature_2_v0_s0 ?Arg0 ?Arg1)
      (not (Feature_2_v0_s1 ?Arg0 ?Arg1)) (not (Feature_2_v0_s0 ?Arg0 ?Arg3))
    )
  )
  (:action unload
    :parameters (?Arg0 - Type0 ?Arg1 - Type1 ?Arg2 - Type2)
    :precondition (and
      (Feature_3_v0_s0 ?Arg1 ?Arg2) (Feature_1_v0_s1 ?Arg0 ?Arg2) (Feature_0_v0_s0 ?Arg0 ?Arg1) (Feature_2_v0_s0 ?Arg1 ?Arg2)
  ...
  (:action fly
    ...
    :precondition (and
      (Feature_3_v0_s0 ?Arg0 ?Arg2) (Feature_3_v0_s1 ?Arg0 ?Arg1) (Static_fly ?Arg0 ?Arg1 ?Arg2)
    )
    :effect (and
