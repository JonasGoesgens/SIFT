(define (domain driverlog)
  ...
  (:action load-truck
    ...
    :precondition (and
      (Feature_4_v0_s0 ?Arg2 ?Arg3 ?Arg1) (Feature_3_v0_s1 ?Arg1 ?Arg0) (Feature_2_v0_s0 ?Arg3 ?Arg0) (Feature_1_v0_s0 ?Arg2 ?Arg1)
  ...
  (:action disembark-truck
    ...
    :precondition (and
      (Feature_4_v0_s0 ?Arg0 ?Arg1 ?Arg2) (Feature_0_v0_s1 ?Arg0 ?Arg1) (Feature_1_v0_s1 ?Arg1 ?Arg2) (Static_disembark-truck ?Arg0 ?Arg1 ?Arg2)
    )
    :effect (and
      (Feature_1_v0_s0 ?Arg1 ?Arg2) (Feature_4_v0_s1 ?Arg0 ?Arg1 ?Arg2) (Feature_0_v0_s0 ?Arg0 ?Arg1)
      (not (Feature_4_v0_s0 ?Arg0 ?Arg1 ?Arg2)) (not (Feature_0_v0_s1 ?Arg0 ?Arg1)) (not (Feature_1_v0_s1 ?Arg1 ?Arg2))
    )
  )
  (:action unload-truck
    :parameters (?Arg0 - Type2 ?Arg1 - Type1 ?Arg2 - Type0 ?Arg3 - Type0)
