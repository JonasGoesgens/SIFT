(define (domain blocks_world)
  ...
  (:action stack
    ...
    :precondition (and
      (Feature_2_v0_s1 ?Arg1 ?Arg0) (Feature_0_v0_s1 ?Arg1) (Feature_0_v0_s1 ?Arg0) (Feature_1_v0_s1 ?Arg0)
      (Feature_2_v0_s1 ?Arg0 ?Arg1) (Static_stack ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_2_v0_s0 ?Arg0 ?Arg1) (Feature_0_v0_s0 ?Arg1) (Feature_2_v0_s0 ?Arg1 ?Arg0) (Feature_1_v0_s0 ?Arg0)
      (not (Feature_2_v0_s1 ?Arg1 ?Arg0)) (not (Feature_0_v0_s1 ?Arg1)) (not (Feature_1_v0_s1 ?Arg0)) (not (Feature_2_v0_s1 ?Arg0 ?Arg1))
    )
  )
  (:action newtower
    :parameters (?Arg0 - Type0 ?Arg1 - Type0)
    :precondition (and
      (Feature_2_v0_s0 ?Arg0 ?Arg1) (Feature_0_v0_s1 ?Arg0) (Feature_1_v0_s0 ?Arg0) (Feature_0_v0_s0 ?Arg1)
      (Feature_2_v0_s0 ?Arg1 ?Arg0) (Static_newtower ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_2_v0_s1 ?Arg1 ?Arg0) (Feature_0_v0_s1 ?Arg1) (Feature_1_v0_s1 ?Arg0) (Feature_2_v0_s1 ?Arg0 ?Arg1)
      (not (Feature_2_v0_s0 ?Arg0 ?Arg1)) (not (Feature_0_v0_s0 ?Arg1)) (not (Feature_2_v0_s0 ?Arg1 ?Arg0)) (not (Feature_1_v0_s0 ?Arg0))
    )
  )
  (:action move
