(define (domain driverlog)
  ...
  (:action disembark-truck
    ...
    :precondition (and
      (Feature_0_v0_s1 ?Arg0 ?Arg1) (Feature_4_v0_s0 ?Arg0 ?Arg1 ?Arg2) (Feature_2_v0_s1 ?Arg1 ?Arg2) (Static_disembark-truck ?Arg0 ?Arg1 ?Arg2)
    )
    :effect (and
      (Feature_4_v0_s1 ?Arg0 ?Arg1 ?Arg2) (Feature_2_v0_s0 ?Arg1 ?Arg2) (Feature_0_v0_s0 ?Arg0 ?Arg1)
      (not (Feature_0_v0_s1 ?Arg0 ?Arg1)) (not (Feature_4_v0_s0 ?Arg0 ?Arg1 ?Arg2)) (not (Feature_2_v0_s1 ?Arg1 ?Arg2))
    )
  )
)
