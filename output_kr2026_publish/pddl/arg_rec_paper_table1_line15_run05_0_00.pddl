(define (domain logistics)
  ...
  (:action unload
    ...
    :precondition (and
      (Feature_1_v0_s0 ?Arg1 ?Arg2) (Feature_0_v0_s0 ?Arg0 ?Arg1) (Feature_3_v0_s0 ?Arg1 ?Arg2 ?Arg3) (Feature_2_v0_s1 ?Arg0 ?Arg2 ?Arg3)
      (Static_unload ?Arg0 ?Arg1 ?Arg2 ?Arg3)
    )
    :effect (and
      (Feature_0_v0_s1 ?Arg0 ?Arg1) (Feature_2_v0_s0 ?Arg0 ?Arg2 ?Arg3)
      (not (Feature_0_v0_s0 ?Arg0 ?Arg1)) (not (Feature_2_v0_s1 ?Arg0 ?Arg2 ?Arg3))
    )
  )
  (:action load
    :parameters (?Arg0 - Type0 ?Arg1 - Type1 ?Arg2 - Type2 ?Arg3 - Type3)
    :precondition (and
      (Feature_1_v0_s0 ?Arg1 ?Arg2) (Feature_0_v0_s1 ?Arg0 ?Arg1) (Feature_2_v0_s0 ?Arg0 ?Arg2 ?Arg3) (Feature_3_v0_s0 ?Arg1 ?Arg2 ?Arg3)
      (Static_load ?Arg0 ?Arg1 ?Arg2 ?Arg3)
    )
    :effect (and
      (Feature_0_v0_s0 ?Arg0 ?Arg1) (Feature_2_v0_s1 ?Arg0 ?Arg2 ?Arg3)
      (not (Feature_0_v0_s1 ?Arg0 ?Arg1)) (not (Feature_2_v0_s0 ?Arg0 ?Arg2 ?Arg3))
    )
  )
  (:action drive
  ...
  (:action fly
    ...
    :precondition (and
      (Feature_1_v0_s0 ?Arg0 ?Arg2) (Feature_1_v0_s1 ?Arg0 ?Arg1) (Static_fly ?Arg0 ?Arg1 ?Arg2 ?Arg3 ?Arg4)
    )
    :effect (and
      (Feature_1_v0_s1 ?Arg0 ?Arg2) (Feature_1_v0_s0 ?Arg0 ?Arg1)
      (not (Feature_1_v0_s0 ?Arg0 ?Arg2)) (not (Feature_1_v0_s1 ?Arg0 ?Arg1))
    )
  )
)
