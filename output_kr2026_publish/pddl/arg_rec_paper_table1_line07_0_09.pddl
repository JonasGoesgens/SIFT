(define (domain gripper)
  ...
  (:action pick
    ...
    :precondition (and
      (Feature_1_v0_s0 ?Arg2) (Feature_3_v0_s1 ?Arg0 ?Arg2) (Feature_0_v0_s1 ?Arg1) (Feature_2_v0_s1 ?Arg0 ?Arg1)
      (Static_pick ?Arg0 ?Arg1 ?Arg2)
    )
    :effect (and
      (Feature_0_v0_s0 ?Arg1) (Feature_3_v0_s0 ?Arg0 ?Arg2) (Feature_2_v0_s0 ?Arg0 ?Arg1)
      (not (Feature_3_v0_s1 ?Arg0 ?Arg2)) (not (Feature_0_v0_s1 ?Arg1)) (not (Feature_2_v0_s1 ?Arg0 ?Arg1))
    )
  )
  (:action move
  ...
  (:action drop
    ...
    :precondition (and
      (Feature_2_v0_s0 ?Arg2 ?Arg0) (Feature_3_v0_s0 ?Arg2 ?Arg1) (Feature_1_v0_s0 ?Arg1) (Feature_0_v0_s0 ?Arg0)
      (Static_drop ?Arg0 ?Arg1 ?Arg2)
    )
    :effect (and
      (Feature_2_v0_s1 ?Arg2 ?Arg0) (Feature_0_v0_s1 ?Arg0) (Feature_3_v0_s1 ?Arg2 ?Arg1)
      (not (Feature_3_v0_s0 ?Arg2 ?Arg1)) (not (Feature_2_v0_s0 ?Arg2 ?Arg0)) (not (Feature_0_v0_s0 ?Arg0))
    )
  )
)
