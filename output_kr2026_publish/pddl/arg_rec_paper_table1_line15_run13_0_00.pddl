(define (domain logistics)
  ...
  (:action load
    ...
    :precondition (and
      (Feature_2_v0_s0 ?Arg2 ?Arg0) (Feature_3_v0_s0 ?Arg1 ?Arg2 ?Arg3) (Feature_1_v0_s1 ?Arg1 ?Arg0) (Feature_0_v0_s0 ?Arg1 ?Arg2)
      (Static_load ?Arg0 ?Arg1 ?Arg2 ?Arg3)
    )
    :effect (and
      (Feature_2_v0_s1 ?Arg2 ?Arg0) (Feature_1_v0_s0 ?Arg1 ?Arg0)
  ...
  (:action unload
    :parameters (?Arg0 - Type2 ?Arg1 - Type0 ?Arg2 - Type1 ?Arg3 - Type3)
    :precondition (and
      (Feature_2_v0_s1 ?Arg2 ?Arg0) (Feature_3_v0_s0 ?Arg1 ?Arg2 ?Arg3) (Feature_1_v0_s0 ?Arg1 ?Arg0) (Feature_0_v0_s0 ?Arg1 ?Arg2)
      (Static_unload ?Arg0 ?Arg1 ?Arg2 ?Arg3)
    )
    :effect (and
      (Feature_2_v0_s0 ?Arg2 ?Arg0) (Feature_1_v0_s1 ?Arg1 ?Arg0)
      (not (Feature_2_v0_s1 ?Arg2 ?Arg0)) (not (Feature_1_v0_s0 ?Arg1 ?Arg0))
    )
  )
)
