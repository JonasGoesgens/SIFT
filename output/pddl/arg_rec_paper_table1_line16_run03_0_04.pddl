(define (domain sdelivery)
  ...
  (:action drop
    ...
    :precondition (and
      (Feature_3_v0_s1 ?Arg0 ?Arg1) (Feature_0_v0_s0) (Feature_1_v0_s0 ?Arg0) (Feature_2_v0_s0 ?Arg1)
      (Static_drop ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_0_v0_s1) (Feature_3_v0_s0 ?Arg0 ?Arg1) (Feature_1_v0_s1 ?Arg0)
      (not (Feature_3_v0_s1 ?Arg0 ?Arg1)) (not (Feature_0_v0_s0)) (not (Feature_1_v0_s0 ?Arg0))
    )
  )
  (:action up
  ...
  (:action pick
    :parameters (?Arg0 - Type0 ?Arg1 - Type1)
    :precondition (and
      (Feature_0_v0_s1) (Feature_2_v0_s0 ?Arg1) (Feature_3_v0_s0 ?Arg0 ?Arg1) (Feature_1_v0_s1 ?Arg0)
      (Static_pick ?Arg0 ?Arg1)
    )
    :effect (and
      (Feature_3_v0_s1 ?Arg0 ?Arg1) (Feature_0_v0_s0) (Feature_1_v0_s0 ?Arg0)
      (not (Feature_0_v0_s1)) (not (Feature_3_v0_s0 ?Arg0 ?Arg1)) (not (Feature_1_v0_s1 ?Arg0))
    )
  )
  (:action left
    :parameters (?Arg0 - Type1 ?Arg1 - Type1)
